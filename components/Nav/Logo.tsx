    ...
    <div className="relative text-[#312e81] dark:text-muted-50">
      ...
      >
        <svg
          ...
          <defs xmlns="http://www.w3.org/2000/svg"><linearGradient gradientTransform="rotate(135, 0.5, 0.5)" x1="50%" y1="0%" x2="50%" y2="100%" id="ffflux-gradient"><stop stopColor="hsl(300, 60%, 64%)" stopOpacity="1" offset="0%" /><stop stopColor="hsl(218, 68%, 57%)" stopOpacity="1" offset="100%" /></linearGradient><filter id="ffflux-filter" x="-20%" y="-20%" width="140%" height="140%" filterUnits="objectBoundingBox" primitiveUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
