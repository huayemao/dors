...
import { Dispatch, FC, PropsWithChildren, createContext, useContext, useReducer, useState } from "react";

const initialState = {
    list: [] as any[]
};

export const HerbalContext =
    createContext(initialState);

export const HerbalContextProvider: FC<
    PropsWithChildren<{
    }>
> = ({ children }) => {
...
const HerbalDispatchContext = createContext<
