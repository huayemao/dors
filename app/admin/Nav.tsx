    ...
    <>
      ...
      >
        <div className="relative size-5 scale-90">
          ...
          <span
            className={cn(
              "bg-primary-500 dark:bg-muted-100 absolute block h-0.5 w-full transition-all duration-300  max-w-[75%]  bottom-0",
  ...
  return (
    <div>
      <AnimatePresence>
        ...
        {isDeskTop && (
          <div className="dark:bg-muted-800 border-muted-200 dark:border-muted-700 fixed start-0 top-0 z-[30] flex h-full flex-col items-center border-r bg-white  w-[240px]">
            {Content}
          </div>
        )}
      </AnimatePresence>
